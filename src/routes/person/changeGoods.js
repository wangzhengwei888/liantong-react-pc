...
import { changeGoods_body } from './changeGoods.less';
...
const columns = [{
  ...
  render: () => (
    <span>
      <a href="/person/backDetail" style={{color:'#333'}}>查看</a>
    </span>
  ),
}];
...
class  BackGoods extends Component{
  ...
  render (){
    ...
    return (
      <div className={changeGoods_body}>
        <div className="changeGoods_content">
          {/*头部单行条*/}
