...
import { circleList_body,} from './circleList.less';
...
class CircleList extends Component {
  ...
  goCircleListAdm = () => {
  this.props.dispatch(routerRedux.push('/person/circleListAdm'));
}
  render(){
    return(
      <div className={circleList_body}>
        <div className="orderList_head">
          <Breadcrumb separator=">">
            <Breadcrumb.Item><a href="">我的商城</a></Breadcrumb.Item>
            <Breadcrumb.Item><a href="">我的圈子</a></Breadcrumb.Item>
            <Breadcrumb.Item><a style={{fontWeight:'bold',fontSize:'14px'}} href="">圈子列表</a></Breadcrumb.Item>
          </Breadcrumb>
        </div>
            ...
            <div className="orderList_content_goods">
              ...
              <table className="border_bottom">
                ...
                <tr>
                  ...
                  <td style={{width:'12.5%'}}>
                    <p style={{lineHeight:'25px'}} ><Icon type="heart" style={{marginRight:'5px'}} />1</p>
                  ...
                  <td className='border_left'>
                    <div className="goods_div2">
                      <div style={{color:'#ff0000',cursor:'pointer'}} onClick={()=>this.goCircleListAdm()}>管理</div>
                    </div>
                  </td>
                </tr>
                </tbody>
