...
class GoodsPrintList extends Component {
 ...
 render() {
    ...
    let { coaListData } =this.props.technology;
...
export default connect(({technology,goodsDetail, app}) => ({technology,goodsDetail, app}), (dispatch, own) => {return {dispatch, own}})(GoodsPrintList);
